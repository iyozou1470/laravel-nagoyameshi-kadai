...
//管理者追加Admin2
Route::middleware(['guest', 'guest:admin2'])->group(function () {
    Route::get('register', [RegisteredUserController::class, 'create'])
                ->name('register');
...
//管理者追加Admin2
Route::middleware('guest:admin2')->group(function () {
    Route::get('admin2/login', [Admin\Auth\AuthenticatedSessionController::class, 'create'])
                ->name('admin2.login');
...
Route::middleware('auth:admin2')->group(function () {
    Route::post('admin2/logout', [Admin\Auth\AuthenticatedSessionController::class, 'destroy'])
                ->name('admin2.logout');
});